    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          {/* Main Title */}
          <h1 className="text-3xl font-bold text-center mb-8 first-letter:text-4xl text-muted-foreground" style={{ fontFamily: 'Furore' }}>
            discord сервер
          </h1>
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                {/* Widget Title */}
                <h2 className="text-xl font-semibold text-center first-letter:text-3xl text-muted-foreground" style={{ fontFamily: 'Furore' }}>
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-xl font-semibold first-letter:text-2xl text-muted-foreground" style={{ fontFamily: 'Furore' }}>
                как присоединиться к серверу
              </h2>
              <p className="text-lg first-letter:text-xl text-muted-foreground" style={{ fontFamily: 'Furore' }}>
              ...
              <div className="space-y-4">
                ...
                <h3 className="text-xl font-semibold first-letter:text-2xl text-muted-foreground" style={{ fontFamily: 'Furore' }}>
                  дополнительно
                </h3>
