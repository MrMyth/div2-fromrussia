    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          {/* Main Title */}
          <h1 className="text-3xl font-bold text-center mb-8" style={{ fontFamily: 'Neucha', color: '#F97316' }}>
            Discord сервер
          </h1>
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                {/* Widget Title */}
                <h2 className="text-xl font-semibold text-center" style={{ fontFamily: 'Neucha', color: '#F97316' }}>
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-xl font-semibold" style={{ fontFamily: 'Neucha', color: '#F97316' }}>
                Как присоединиться к серверу
              </h2>
              <p className="text-lg" style={{ fontFamily: 'Neucha', color: '#F97316' }}>
              ...
              <div className="space-y-4">
                ...
                <h3 className="text-xl font-semibold" style={{ fontFamily: 'Neucha', color: '#F97316' }}>
                  Дополнительно
                </h3>
