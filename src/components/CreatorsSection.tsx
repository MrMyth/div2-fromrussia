...
import { Youtube, Twitch, User } from "lucide-react";
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          <h1 className="catchphrase text-center mb-8">Наши каналы</h1>
          
          {/* MuRomeZ Block */}
          <div className="space-y-4 p-6 rounded-lg mb-8">
            <h2 className="subheading text-center">MuRomeZ</h2>
          ...
          <div className="space-y-4 p-6 rounded-lg">
            <h2 className="subheading text-center">MrMyth92</h2>
            <div className="flex justify-center gap-4 flex-wrap">
              <Button
                variant="default"
                className="bg-[#FF0000] hover:bg-[#FF0000]/90 text-white rounded-lg flex items-center gap-2 py-6 text-lg"
              ...
              <Button
                variant="default"
                className="bg-[#0077FF] hover:bg-[#0077FF]/90 text-white rounded-lg flex items-center gap-2 py-6 text-lg"
              ...
              <Button
                variant="default"
                className="bg-[#9146FF] hover:bg-[#9146FF]/90 text-white rounded-lg flex items-center gap-2 py-6 text-lg"
                onClick={() => window.open('https://www.twitch.tv/mrmyth1992', '_blank')}
              >
              ...
              <Button
                variant="default"
                className="bg-gray-700 hover:bg-gray-700/90 text-white rounded-lg flex items-center gap-2 py-6 text-lg"
